...
let kColorThresholdFloorBrightness: CGFloat = 0.25 // original: 0.25
let kColorThresholdCeilingBrightness: CGFloat = 0.75
let kColorLighterRatio: CGFloat = 1.6 // original: 1.3
let kColorDarkerRatio: CGFloat = 0.6 // original: 0.75
...
let kColorContrastRatio: CGFloat = 1.8  // original: 1.6
